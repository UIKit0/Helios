...
namespace helios
{
    ...
    CameraComponent::Process()
    {
        ...
        glm::mat4 ppos = glm::rotate(mPos, sinf(x) * 100.f, glm::vec3(0.2f,0.7f,0.f)) * glm::translate(glm::mat4(1.f), -mAnchorPos);
        
        x += 0.01;
        glm::mat3 vecTrans(ppos);
        
        
        glm::vec3 look = vecTrans * mDirectionVector;
        glm::vec3 up = vecTrans * mUpVector;
        
        glm::vec4 pos = ppos * glm::vec4(0.f,0.f,0.f,1.f);
