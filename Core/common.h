...
namespace helios
{
    namespace e
    {
        ...
        extern std::string const kFragmentUniformFBOSize;
        extern std::string const kFragmentUniformLightColor;
        extern std::string const kFragmentUniformLightPos;
        extern std::string const kFragmentUniformLightCount;
